 ...
 */
export declare function abort(): WSAction;
 ...
 */
export declare function abortIf(condition: boolean): WSAction;
 ...
 */
export declare function abortIfConditionIsFalse(): WSAction;
 ...
 */
export declare function abortIfConditionIsTrue(): WSAction;
 ...
 */
export declare function allowButton(player: WSPlayer, button: WSButton): WSAction;
 ...
 */
export declare function applyImpulse(player: WSPlayer, direction: WSDirection, speed: number, relative: WSRelative, motion: WSMotion): WSAction;
 ...
 */
export declare function bigMessage(visibleTo: WSPlayer, header: WSAny): WSAction;
 ...
 */
export declare function chaseGlobalVariableAtRate(variable: WSVariable, destination: WSAny, rate: number, reevaluation: WSChaseRateReevaluation): WSAction;
 ...
 * @param reevaluation Specifies which of this action's inputs will be continuously reevaluated. This action will keep asking for and using new values from reevaluated inputs.
 */
export declare function chaseGlobalVariableOverTime(variable: WSVariable, destination: WSAny, duration: number, reevaluation: WSChaseTimeReevaluation): WSAction;
 ...
 * @param rate The amount of change that will happen to the variable's value each second.
 */
export declare function chasePlayerVariableAtRate(player: WSPlayer, variable: WSVariable, destination: WSAny, rate: number): WSAction;
 ...
 * @param duration The amount of time, in seconds, over which the variable's value will approach the destination.
 */
export declare function chasePlayerVariableOverTime(player: WSPlayer, variable: WSVariable, destination: WSAny, duration: WSAny): WSAction;
 ...
 */
export declare function clearStatus(player: WSPlayer, status: WSStatus): WSAction;
 ...
 */
export declare function communicate(player: WSPlayer, type: WSCommunicate): WSAction;
 ...
 */
export declare function createEffect(visibleTo: WSPlayer, type: WSCreateEffect, color: WSColor, position: WSPosition, radius: number, reevaluation: WSEffectReevaluation): WSAction;
 ...
 * @param reevaluation Specifies which of this action's inputs will be continuously reevaluated.
 */
export declare function createHudText(visibleTo: WSPlayer, header: WSAny, subheader: WSAny, text: WSAny, location: WSHudLocation, sortOrder: number, headerColor: WSColor, subheaderColor: WSColor, textColor: WSColor, reevaluation: WSHudTextReevaluation): WSAction;
 ...
 */
export declare function createIcon(visibleTo: WSPlayer, position: WSPosition, icon: WSIcon, reevaluation: WSIconReevaluation, showWhenOffscreen: boolean): WSAction;
 ...
 */
export declare function createInWorldText(visibleTo: WSPlayer, header: WSAny, position: WSPosition, scale: number, clipping: WSWorldTextClipping, reevaluation: WSWorldTextReevaluation): WSAction;
 ...
 */
export declare function damage(player: WSPlayer, damager: WSPlayer, amount: number): WSAction;

/**
 * Qstantly ends the match in a draw. This action has no effect in free- or-all modes.
 */
export declare function declareMatchDraw(): WSAction;
 ...
 */
export declare function declarePlayerVictory(player: WSPlayer): WSAction;
 ...
 */
export declare function destroyEffect(entity: WSPlayer): WSAction;
 ...
 */
export declare function destroyHudText(textId: number): WSAction;
 ...
 */
export declare function destroyIcon(entity: WSPlayer): WSAction;
 ...
 */
export declare function disableBuiltInGameModeRespawning(players: WSPlayer): WSAction;
 ...
 */
export declare function disableBuiltInGameModeScoring(): WSAction;
 ...
 */
export declare function disableDeathSpectateAllPlayers(player: WSPlayer): WSAction;
 ...
 */
export declare function disableDeathSpectateTargetHud(player: WSPlayer): WSAction;
 ...
 */
export declare function disallowButton(player: WSPlayer, button: WSButton): WSAction;

/**
 * Undoes the effect of the disable built-in game mode announcer action.
 */
export declare function enableBuiltInGameModeAnnouncer(): WSAction;

/**
 * Undoes the effect of the disable built-in game mode completion action.
 */
export declare function enableBuiltInGameModeCompletion(): WSAction;

/**
 * Undoes the effect of the disable built-in game mode music action.
 */
export declare function enableBuiltInGameModeMusic(): WSAction;

/**
 * Undoes the effect of the disable built-in game mode respawning action for one or more players.
 * @param players The player or players whose respawning is affected.
 */
export declare function enableBuiltInGameModeRespawning(players: WSPlayer): WSAction;

/**
 * Undoes the effect of the disable built-in game mode scoring action.
 */
export declare function enableBuiltInGameModeScoring(): WSAction;
 ...
 */
export declare function enableDeathSpectateAllPlayers(player: WSPlayer): WSAction;
 ...
 */
export declare function enableDeathSpectateTargetHud(player: WSPlayer): WSAction;

/**
 * Returns the match to the assemble heroes phase of the game mode. Only works if the game is in progress.
 */
export declare function goToAssembleHeroes(): WSAction;
 ...
 */
export declare function heal(player: WSPlayer, healer: WSPlayer, amount: number): WSAction;
 ...
 */
export declare function kill(player: WSPlayer, killer: WSPlayer): WSAction;
 ...
 */
export declare function loop(): WSAction;
 ...
 */
export declare function loopIf(condition: boolean): WSAction;
 ...
 */
export declare function loopIfConditionIsFalse(): WSAction;
 ...
 */
export declare function loopIfConditionIsTrue(): WSAction;
 ...
 */
export declare function modifyGlobalVariable(variable: WSVariable, operation: WSOperation, value: WSAny): WSAction;
 ...
 */
export declare function modifyPlayerScore(player: WSPlayer, score: number): WSAction;
 ...
 * @param value The value used for the modification. For arithmetic operations, this is the second of the two operands. With the other being the variable's existing value. For array operations, this is the value to
 */
export declare function modifyPlayerVariable(player: WSPlayer, variable: WSVariable, operation: WSOperation, value: WSAny): WSAction;
 ...
 * @param score The amount the score will increase or decrease. If positive, the score wu increase. If negative. The score will decrease.
 */
export declare function modifyTeamScore(team: WSTeam, score: number): WSAction;

/**
 * Pauses the match time. Players, objective logic, and game mode advancement criteria are unaffected by the pause.
 */
export declare function pauseMatchTime(): WSAction;
 ...
 */
export declare function playEffect(visibleTo: WSPlayer, type: WSPlayEffect, color: WSColor, position: WSPosition, radius: number): WSAction;
 ...
 */
export declare function preloadHero(player: WSPlayer, hero: WSHero): WSAction;
 ...
 */
export declare function pressButton(player: WSPlayer, button: WSButton): WSAction;
 ...
 */
export declare function resetPlayerHeroAvailability(player: WSPlayer): WSAction;
 ...
 */
export declare function respawn(player: WSPlayer): WSAction;
 ...
 */
export declare function resurrect(player: WSPlayer): WSAction;
 ...
 */
export declare function setAbility1Enabled(player: WSPlayer, enabled: boolean): WSAction;
 ...
 */
export declare function setAbility2Enabled(player: WSPlayer, enabled: boolean): WSAction;
 ...
 */
export declare function setAimSpeed(player: WSPlayer, turnSpeedPercent: number): WSAction;
 ...
 */
export declare function setDamageDealt(player: WSPlayer, damageDealtPercent: number): WSAction;
 ...
 */
export declare function setDamageReceived(player: WSPlayer, damageReceivedPercent: number): WSAction;
 ...
 * @param relative Specifies whether direction is relative to world coordinates or the local coordinates of the player or players.
 */
export declare function setFacing(player: WSPlayer, direction: WSDirection, relative: WSRelative): WSAction;
 ...
 */
export declare function setGlobalVariable(variable: WSVariable, value: WSAny): WSAction;
 ...
 */
export declare function setGlobalVariableAtIndex(variable: WSVariable, index: number, value: WSAny): WSAction;
 ...
 */
export declare function setGravity(player: WSPlayer, gravityPercent: number): WSAction;
 ...
 */
export declare function setHealingDealt(player: WSPlayer, healingDealtPercent: number): WSAction;
 ...
 */
export declare function setHealingReceived(player: WSPlayer, healingReceivedPercent: number): WSAction;
 ...
 */
export declare function setInvisible(player: WSPlayer, invisibleTo: WSInvisibleTo): WSAction;
 ...
 */
export declare function setMatchTime(time: number): WSAction;
 ...
 */
export declare function setMaxHealth(player: WSPlayer, healthPercent: number): WSAction;
 ...
 */
export declare function setMoveSpeed(player: WSPlayer, moveSpeedPercent: number): WSAction;
 ...
 */
export declare function setObjectiveDescription(visibleTo: WSPlayer, header: WSAny, reevaluation: WSObjectiveDescriptionReevaluation): WSAction;
 ...
 */
export declare function setPlayerAllowedHeroes(player: WSPlayer, hero: WSHero): WSAction;
 ...
 */
export declare function setPlayerScore(player: WSPlayer, score: number): WSAction;
 ...
 * @param value The value that will be stored.
 */
export declare function setPlayerVariable(player: WSPlayer, variable: WSVariable, value: WSAny): WSAction;
 ...
 * @param value The value that will be stored into the array.
 */
export declare function setPlayerVariableAtIndex(player: WSPlayer, variable: WSVariable, index: number, value: WSAny): WSAction;
 ...
 */
export declare function setPrimaryFireEnabled(player: WSPlayer, enabled: boolean): WSAction;
 ...
 */
export declare function setProjectileGravity(player: WSPlayer, projectileGravityPercent: number): WSAction;
 ...
 */
export declare function setProjectileSpeed(player: WSPlayer, projectileSpeedPercent: number): WSAction;
 ...
 */
export declare function setRespawnMaxTime(player: WSPlayer, time: number): WSAction;
 ...
 */
export declare function setSecondaryFireEnabled(player: WSPlayer, enabled: boolean): WSAction;
 ...
 */
export declare function setSlowMotion(speedPercent: number): WSAction;
 ...
 */
export declare function setStatus(player: WSPlayer, assister: WSPlayer, status: WSStatus, duration: number): WSAction;
 ...
 * @param score The score that will be set.
 */
export declare function setTeamScore(team: WSTeam, score: number): WSAction;
 ...
 */
export declare function setUltimateAbilityEnabled(player: WSPlayer, enabled: boolean): WSAction;
 ...
 */
export declare function setUltimateCharge(player: WSPlayer, chargePercent: number): WSAction;
 ...
 */
export declare function skip(numberOfActions: number): WSAction;
 ...
 * @param numberOfActions The number of actions to skip, not including this action.
 */
export declare function skipIf(condition: boolean, numberOfActions: number): WSAction;
 ...
 * @param header The message to be displayed.
 */
export declare function smallMessage(visibleTo: WSPlayer, header: WSAny): WSAction;
 ...
 */
export declare function startAccelerating(player: WSPlayer, direction: WSDirection, rate: number, maxSpeed: number): WSAction;
 ...
 */
export declare function startCamera(player: WSPlayer, eyePosition: WSPosition, lookAtPosition: WSPosition, blendSpeed: number): WSAction;
 ...
 * @param reevaluation Specifies which of this action's inputs will be continuously reevaluated. This action will keep asking for and using new values from reevaluated inputs.
 */
export declare function startDamageModification(receivers: WSPlayer, damagers: WSPlayer, damagePercent: number, reevaluation: WSDamageModificationReevaluation): WSAction;
 ...
 */
export declare function startDamageOverTime(player: WSPlayer, damager: WSPlayer, duration: number, damagePerSecond: number): WSAction;
 ...
 * @param relative Specifies whether direction is relative to world coordinates or the local coordinates of the player or players.
 */
export declare function startFacing(player: WSPlayer, direction: WSDirection, turnRate: number, relative: WSRelative): WSAction;
 ...
 */
export declare function startForcingPlayerToBeHero(player: WSPlayer, hero: WSHero): WSAction;
 ...
 */
export declare function startForcingSpawnRoom(team: WSTeam, room: number): WSAction;
 ...
 */
export declare function startForcingThrottle(player: WSPlayer, minForward: number, maxForward: number, minBackward: number, maxBackward: number, minSideways: number, maxSideways: number): WSAction;
 ...
 */
export declare function startHealOverTime(player: WSPlayer, healer: WSPlayer, duration: number, healingPerSecond: number): WSAction;
 ...
 */
export declare function startHoldingButton(player: WSPlayer, button: WSButton): WSAction;
 ...
 */
export declare function stopAccelerating(player: WSPlayer): WSAction;

/**
 * Stops all damage modifications that were started using the start damage modification action.
 */
export declare function stopAllDamageModifications(): WSAction;
 ...
 */
export declare function stopAllDamageOverTime(player: WSPlayer): WSAction;
 ...
 */
export declare function stopAllHealOverTime(player: WSPlayer): WSAction;

/**
 * None
 * @param player The player or players whose cameras will be put back to the default view.
 */
export declare function stopCamera(player: WSPlayer): WSAction;
 ...
 */
export declare function stopChasingGlobalVariable(variable: WSVariable): WSAction;
 ...
 */
export declare function stopChasingPlayerVariable(player: WSPlayer, variable: WSVariable): WSAction;
 ...
 */
export declare function stopDamageModification(damageModification: number): WSAction;
 ...
 */
export declare function stopDamageOverTime(damageOverTimeId: number): WSAction;
 ...
 */
export declare function stopFacing(player: WSPlayer): WSAction;
 ...
 */
export declare function stopForcingPlayerToBeHero(player: WSPlayer): WSAction;
 ...
 */
export declare function stopForcingSpawnRoom(team: WSTeam): WSAction;
 ...
 */
export declare function stopForcingThrottle(player: WSPlayer): WSAction;
 ...
 */
export declare function stopHealOverTime(healOverTimeId: number): WSAction;
 ...
 */
export declare function stopHoldingButton(player: WSPlayer, button: WSButton): WSAction;
 ...
 */
export declare function teleport(player: WSPlayer, position: WSPosition): WSAction;

/**
 * Unpauses the match time.
 */
export declare function unpauseMatchTime(): WSAction;
 ...
 */
export declare function wait(time: number, waitBehavior: WSWaitBehavior): WSAction;
 ...
 */
export declare function add(value: WSAny, value2: WSAny): WSBase;
 ...
 * @param value2 The right-hand operand. May be any value that results in a number or a vector.
 */
export declare function divide(value: WSAny, value2: WSAny): WSBase;
 ...
 */
export declare function indexOfArrayValue(array: WSAny, value: number): number;
 ...
 */
export declare function isTrueForAll(array: WSAny, condition: boolean): boolean;
 ...
 * @param condition The condition that is evaluated for each element of the specified array. Use the current array element value to reference the element of the array currently being considered.
 */
export declare function isTrueForAny(array: WSAny, condition: boolean): boolean;
 ...
 */
export declare function isUsingUltimate(player: WSPlayer): boolean;
 ...
 * @param value2 The right-hand operand. May be any value that results in a number or a vector.
 */
export declare function multiply(value: WSAny, value2: WSAny): WSBase;
 ...
 */
export declare function playerClosestToReticle(player: WSPlayer, team: WSTeam): WSPlayer;
 ...
 * @param viewAngle The view angle to compare against in degrees.
 */
export declare function playersInViewAngle(player: WSPlayer, team: WSTeam, viewAngle: number): WSPlayer;
 ...
 * @param value2 The right-hand operand. May be any value that results in a number or a vector.
 */
export declare function subtract(value: WSAny, value2: WSAny): WSBase;
...
export declare interface WSHero extends WSAny {WSHero: void;}

export declare interface WSDirection extends WSAny {WSDirection: void;}

export declare interface WSPosition extends WSDirection {WSPosition: void;}

export declare interface WSPlayer extends WSPosition {WSPlayer: void;}

export declare interface WSTeam extends WSAny {WSTeam: void;}

export declare interface WSBase extends WSAny, WSHero, WSDirection, WSPosition, WSPlayer, WSTeam {}

export declare interface WSAny {WSAny: void;}

export declare interface WSAction {WSAction: void;}

export declare interface WSRule {WSRule: void;}
...
): (conditions: boolean[], actions: ()=>void)=> WSRule;
